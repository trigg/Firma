...
public class RecipeShape {
	...
	public static RecipeShape makeRecipeShape(String... strings) {
	...
	public boolean matchesAtOffset(boolean isInverse, boolean[] b, int startx, int starty) {
		// First, we need all spots outside this cross section to be removed (or
		// filled in for clay which is inverse)
